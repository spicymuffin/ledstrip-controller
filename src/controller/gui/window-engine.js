...
function createWindow(id) {
    ...
    controlPanel.id = "controlPanel" + id;

    let closeButton = document.createElement("img");
    closeButton.id = "closeButton" + id;
    closeButton.setAttribute("src", "/imgs/close.gif")
    closeButton.setAttribute("style", "float: right;")

    let minimizeButton = document.createElement("img");
    minimizeButton.id = "minimizeButton" + id;
    minimizeButton.setAttribute("src", "/imgs/minimize.gif")
    minimizeButton.setAttribute("style", "float: right;")

    let maximizeButton = document.createElement("img");
    maximizeButton.id = "maximizeButton" + id;
    maximizeButton.setAttribute("src", "/imgs/maximize.gif")
    maximizeButton.setAttribute("style", "float: right;")

    document.getElementById("window" + id + "header").appendChild(controlPanel);
    document.getElementById("controlPanel" + id).appendChild(closeButton);
    document.getElementById("controlPanel" + id).appendChild(minimizeButton);
    document.getElementById("controlPanel" + id).appendChild(maximizeButton);
